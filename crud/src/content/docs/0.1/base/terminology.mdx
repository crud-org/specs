---
title: 2. Terminology
description: This page defines the key terms and concepts used in the CRUD API
  Base Specification, providing a common vocabulary for understanding and
  implementing CRUD APIs across various protocols and storage providers.
slug: 0.1/base/terminology
---
